...
def load_json_file(file_path="data/students.json"):
    """
    ...
    try:
        ...
        print(f"Error: The file '{file_path}' does not contains invalid JSON.")
        return None
...
def main():
    ...
    """
    json_file_path = r"C:\Users\mgrande\Desktop\json parsing\data\students.json"
